========================================================================
    KONSOLENANWENDUNG: Multicastserver-Projektübersicht
========================================================================

Diese Multicastserver-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Multicastserver-Anwendung besteht.


Multicastserver.vcxproj
...
Multicastserver.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Multicastserver.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
